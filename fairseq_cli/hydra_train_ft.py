...
from fairseq_cli.train_ft import main as pre_main
...
if __name__ == "__main__":
    ...
    new_argv_vec = []
    for k in argv:
        if k.startswith("--local_rank"):
            k = "distributed_training.distributed_"+k.replace("--", "")
            new_argv_vec.append(k)
        else:
            new_argv_vec.append(k)

    # Replace sys.argv with our remapped argv
    sys.argv = new_argv_vec
    print("new_argv_vec")
    print(sys.argv)
