...
from fairseq.models.wav2vec.conformer.conformer import Net as ConformerEncoder
...
class Wav2Vec2Config(FairseqDataclass):
    ...
    embed_dim: int = field(
        default=512,
        metadata={
            "help": "embed dimension after feature network."
        },
    )
    conv_subsample_in_ch: int = field(
        default=1,
        metadata={
            "help": "convolutional subsampling in channel."
        },
    )
...
class Wav2Vec2Model(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2Config):
        ...
        self.feature_extractor = Conv2dSubsampling4(input_dim // conv_subsample_in_ch, self.embed, conv_subsample_in_ch)
...
class ConformerEncoder(TransformerEncoder):
    ...
    def extract_features(self, x, padding_mask=None, tgt_layer=None, min_layer=0):
        ...
        for i, layer in enumerate(self.layers):
            ...
            elif not self.training or (dropout_probability > self.layerdrop):
                x, (z,lr) = layer(
                    x,
                    self_attn_padding_mask=padding_mask,
                    need_weights=False,
