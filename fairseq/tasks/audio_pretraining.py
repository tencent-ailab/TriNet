...
from fairseq.data import BinarizedAudioDataset, FileArkDataset
...
class AudioPretrainingConfig(FairseqDataclass):
    ...
    data_list: str = field(default=MISSING, metadata={"help": "path to data list"})
    ...
    queue_size: int = field(
        default=8,
        metadata={"help": "size of queue for datalist loader."},
    )
...
class AudioPretrainingTask(FairseqTask):
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = FileArkDataset(
    ...
    def build_model(self, model_cfg: AudioPretrainingConfig, from_checkpoint=False):
